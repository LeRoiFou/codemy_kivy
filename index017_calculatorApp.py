"""
Kivy - Codemy.com #17 : Secondary Calculator Button Functions - Python Kivy GUI Tutorial #17
Lien : https://www.youtube.com/watch?v=yzcGh1R6Qes&list=PLCC34OHNcOtpz7PJQ7Tv7hqFBP_xDDjqg&index=17

Dans ce programme on apprend :
-> à afficher les décimales ;
-> à supprimer chiffre par chiffre ;
-> à afficher le '+/-'
...
Builder.load_file('index017_calculatorApp.kv')  # cette instruction va récupérer le nom du fichier .kv à lier avec ce script
...
class MyLayout(Widget):  # Widget en argument car le constructeur de la classe est dans le fichier .kv
    ...
    def dot(self):
        ...
        if '.' in prior:
            """Si le '.' a déjà été mis, il n'y aura plus de '.' affiché"""
            pass
        else:
            """Ajout du caractère '.' aux chiffres affichés"""
            prior = f"{prior}."
