"""
Kivy - Codemy.com #6 : The Kivy Builder - Python Kivy GUI Tutorial #6
Lien : https://www.youtube.com/watch?v=dVVPOPuPPc0&list=PLCC34OHNcOtpz7PJQ7Tv7hqFBP_xDDjqg&index=6

Dans ce programme on a recours à l'instruction Builder (constructeur) qui permet de récupérer le nom du fichier .kv à
lier avec ce script
...
Builder.load_file('index006_builder.kv')  # cette instruction va récupérer le nom du fichier .kv à lier avec ce script
