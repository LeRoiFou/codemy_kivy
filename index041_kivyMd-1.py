...
from kivymd.app import MDApp  # récupérération dans le répertoire KivyMd :
# C:\Users\LRCOM\PycharmProjects\codemy_kivy\kivymd\KivyMD\kivymd\uix\card.py
# à partir de la ligne 30 -> partie code-block:: python

Builder.load_file('index041_kivyMd-1.kv')  # cette instruction va récupérer le nom du fichier .kv à lier avec ce script
...
class AwesomeApp(MDApp):  # App en argument car on a recours à la bibliothèque KivyMd cette fois-ci
    ...
    # script.
    # Mais cette fois-ci on modifie les paramètres de cette classe avec les données figurant dans le fichier .py
    # de KivyMd dans le répertoire suivant : C:\Users\LRCOM\PycharmProjects\codemy_kivy\kivymd\KivyMD\kivymd\uix\card.py
    # Instruction récupérées à la ligne 44
